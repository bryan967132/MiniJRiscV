...
public class Builtins {
    ...
    public static void greater(RiscVGen gen) {
    ...
    public static void lessEqualStrings(RiscVGen gen) {
        ...
        gen.blt(R.T0.n, R.T1.n, labelFalse);
    ...
    public static void greaterEqualStrings(RiscVGen gen) {
        ...
        gen.lb(R.T1.n, R.A1.n);
        gen.lb(R.T0.n, R.A0.n);
        gen.blt(R.T1.n, R.T0.n, labelFalse);
        gen.beq(R.T1.n, R.Z.n, labelTrue);
        gen.addi(R.A1.n, R.A1.n, 1);
        gen.addi(R.A0.n, R.A0.n, 1);
        gen.j(loop);
    ...
    public static void lessStrings(RiscVGen gen) {
        String loop = gen.getLabel();
        String labelTrue = gen.getLabel();
        String labelFalse = gen.getLabel();
        String end = gen.getLabel();
        ...
        gen.lb(R.T1.n, R.A1.n);
        gen.lb(R.T0.n, R.A0.n);
        gen.bge(R.T1.n, R.T0.n, labelFalse);
        gen.beq(R.T1.n, R.Z.n, labelTrue);
        gen.addi(R.A1.n, R.A1.n, 1);
        gen.addi(R.A0.n, R.A0.n, 1);
        gen.j(loop);
    ...
    public static void greaterStrings(RiscVGen gen) {
        String loop = gen.getLabel();
        String labelTrue = gen.getLabel();
        String labelFalse = gen.getLabel();
        String end = gen.getLabel();
        ...
        gen.lb(R.T1.n, R.A1.n);
        gen.lb(R.T0.n, R.A0.n);
        gen.bge(R.T0.n, R.T1.n, labelFalse);
        gen.beq(R.T1.n, R.Z.n, labelTrue);
        gen.addi(R.A1.n, R.A1.n, 1);
        gen.addi(R.A0.n, R.A0.n, 1);
        gen.j(loop);
